...
//}
//
//void render_context_t::moveTo(coord_t x, coord_t y) const
//{
//    auto hdc = g_hdc;
//    MoveToEx(hdc, (int)x, (int)y, NULL);
//}
//
//void render_context_t::lineTo(coord_t x, coord_t y, color_t color, uint16_t thickness) const
//{
//    auto hdc = g_hdc;
...
//}
//
//void render_context_t::angleArc(const point_t& pt, uint16_t radius, uint8_t startAngle, uint8_t sweepAngle, color_t color, uint8_t thickness) const
//{
//    auto hdc = g_hdc;
//    auto pen = CreatePen(PS_SOLID, thickness, color);
//    auto penOrigin = SelectObject(hdc, pen);
